    ...
    def scramble(self):
        ...
        for index, word in enumerate(sentence):
            ...
            if len(word) > 3:
                ...
                temp_word = list(word)  # we use a list for item assignment, but could also
                                        # just use another new string variable
...
word_scrambler = WordScramble() #instance
word_scrambler.scramble() #call method from instance
